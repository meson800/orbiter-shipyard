...
//! constructor
CSceneNodeAnimatorCameraCustom::CSceneNodeAnimatorCameraCustom(gui::ICursorControl* cursor,
...
//! destructor
CSceneNodeAnimatorCameraCustom::~CSceneNodeAnimatorCameraCustom()
{
	if (CursorControl)
		CursorControl->drop();
}
...
void CSceneNodeAnimatorCameraCustom::animateNode(ISceneNode *node, u32 timeMs)
{
...
bool CSceneNodeAnimatorCameraCustom::isMouseKeyDown(s32 key) const
{
	return MouseKeys[key];
}


void CSceneNodeAnimatorCameraCustom::allKeysUp()
{
	for (s32 i=0; i<3; ++i)
		MouseKeys[i] = false;
}
...
void CSceneNodeAnimatorCameraCustom::setRotateSpeed(f32 speed)
{
	RotateSpeed = speed;
}
...
void CSceneNodeAnimatorCameraCustom::setMoveSpeed(f32 speed)
{
...
//! Sets the zoom speed
void CSceneNodeAnimatorCameraCustom::setZoomSpeed(f32 speed)
{
	ZoomSpeed = speed;
}
...
//! Set the distance
void CSceneNodeAnimatorCameraCustom::setDistance(f32 distance)
{
...
f32 CSceneNodeAnimatorCameraCustom::getRotateSpeed() const
{
	return RotateSpeed;
}
...
f32 CSceneNodeAnimatorCameraCustom::getMoveSpeed() const
{
...
//! Gets the zoom speed
f32 CSceneNodeAnimatorCameraCustom::getZoomSpeed() const
{
	return ZoomSpeed;
}
...
f32 CSceneNodeAnimatorCameraCustom::getDistance() const
{
	return CurrentZoom;
}


ISceneNodeAnimator* CSceneNodeAnimatorCameraCustom::createClone(ISceneNode* node, ISceneManager* newManager)
{
	CSceneNodeAnimatorCameraCustom * newAnimator =
		new CSceneNodeAnimatorCameraCustom(CursorControl, RotateSpeed, ZoomSpeed, TranslateSpeed);
	return newAnimator;
}
