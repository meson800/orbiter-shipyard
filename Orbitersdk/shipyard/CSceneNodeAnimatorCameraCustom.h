...
namespace scene
{
	...
	*/
	class CSceneNodeAnimatorCameraCustom : public ISceneNodeAnimatorCameraMaya 
	{
	public:
		//! Constructor
		CSceneNodeAnimatorCameraCustom(gui::ICursorControl* cursor, f32 rotateSpeed = -1500.f, 
			f32 zoomSpeed = 200.f, f32 translationSpeed = 1500.f, f32 distance=70.f);

		//! Destructor
		virtual ~CSceneNodeAnimatorCameraCustom();
